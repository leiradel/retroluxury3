...
static lutil_FieldDesc const sapp_event_fields[19] = {
    /*   1 */ {DJB2HASH_C(0xd9cf79d8), LUTIL_U64, "frame_count", LUTIL_OFS(sapp_event, frame_count), NULL, 0},
    /*   2 */ {DJB2HASH_C(0x7c9ebd07), LUTIL_ENUM, "type", LUTIL_OFS(sapp_event, type), NULL, 0},
    /*   3 */ {DJB2HASH_C(0xbb20b728), LUTIL_ENUM, "key_code", LUTIL_OFS(sapp_event, key_code), NULL, 0},
    /*   4 */ {DJB2HASH_C(0x34a71d1d), LUTIL_U32, "char_code", LUTIL_OFS(sapp_event, char_code), NULL, 0},
    /*   5 */ {DJB2HASH_C(0x287a2f0e), LUTIL_BOOL, "key_repeat", LUTIL_OFS(sapp_event, key_repeat), NULL, 0},
    /*   6 */ {DJB2HASH_C(0x09c26f07), LUTIL_U32, "modifiers", LUTIL_OFS(sapp_event, modifiers), NULL, 0},
    /*   7 */ {DJB2HASH_C(0xe42516a9), LUTIL_ENUM, "mouse_button", LUTIL_OFS(sapp_event, mouse_button), NULL, 0},
    /*   8 */ {DJB2HASH_C(0xd5be1645), LUTIL_FLOAT, "mouse_x", LUTIL_OFS(sapp_event, mouse_x), NULL, 0},
    /*   9 */ {DJB2HASH_C(0xd5be1646), LUTIL_FLOAT, "mouse_y", LUTIL_OFS(sapp_event, mouse_y), NULL, 0},
    /*  10 */ {DJB2HASH_C(0x8d80dcc9), LUTIL_FLOAT, "mouse_dx", LUTIL_OFS(sapp_event, mouse_dx), NULL, 0},
    /*  11 */ {DJB2HASH_C(0x8d80dcca), LUTIL_FLOAT, "mouse_dy", LUTIL_OFS(sapp_event, mouse_dy), NULL, 0},
    /*  12 */ {DJB2HASH_C(0x740d326b), LUTIL_FLOAT, "scroll_x", LUTIL_OFS(sapp_event, scroll_x), NULL, 0},
    /*  13 */ {DJB2HASH_C(0x740d326c), LUTIL_FLOAT, "scroll_y", LUTIL_OFS(sapp_event, scroll_y), NULL, 0},
    /*  14 */ {DJB2HASH_C(0x444b846f), LUTIL_INT, "num_touches", LUTIL_OFS(sapp_event, num_touches), NULL, 0},
    /*  15 */ {DJB2HASH_C(0xf08d0700), LUTIL_STRUCT, "touches", LUTIL_OFS(sapp_event, touches), &sapp_touchpoint_desc, 14},
    /*  16 */ {DJB2HASH_C(0x290c545c), LUTIL_INT, "window_width", LUTIL_OFS(sapp_event, window_width), NULL, 0},
    /*  17 */ {DJB2HASH_C(0x2753a375), LUTIL_INT, "window_height", LUTIL_OFS(sapp_event, window_height), NULL, 0},
    /*  18 */ {DJB2HASH_C(0xec986829), LUTIL_INT, "framebuffer_width", LUTIL_OFS(sapp_event, framebuffer_width), NULL, 0},
    /*  19 */ {DJB2HASH_C(0x5c6230e2), LUTIL_INT, "framebuffer_height", LUTIL_OFS(sapp_event, framebuffer_height), NULL, 0},
};
